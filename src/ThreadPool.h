...
private:
    ...
    void handleRecvEvent(Epoll &myEpoll, std::unordered_map<int, std::pair<int, std::string>> &sendingBuffer,
                         std::unordered_map<int,std::string> &recvingBuffer,const std::shared_ptr<Socket>& socketPtr);
    void handleSendEvent(Epoll &myEpoll, std::unordered_map<int, std::pair<int, std::string>> &sendingBuffer, const std::shared_ptr<Socket>& socketPtr);
